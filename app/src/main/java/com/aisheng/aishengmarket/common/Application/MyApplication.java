package com.aisheng.aishengmarket.common.Application;
...
/**
 * Created by chz1992 on 2016/11/30.
 */

public class MyApplication extends Application {

    public static String ID_Currunt = MyConstant.ID_FS;
    //全局上下文环境
    ...
    private void initOkGo() {
        ...
        try {
            ...
            OkGo.getInstance()
                    ...
                    .setConnectTimeout(OkGo.DEFAULT_MILLISECONDS)  //全局的连接超时时间  60秒
                    .setReadTimeOut(OkGo.DEFAULT_MILLISECONDS)     //全局的读取超时时间  60秒
                    .setWriteTimeOut(OkGo.DEFAULT_MILLISECONDS)    //全局的写入超时时间  60秒
